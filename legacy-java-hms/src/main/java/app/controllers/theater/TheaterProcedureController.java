...
@RouteController(path = "/Hms/Theater/Procedures")
public class TheaterProcedureController extends Controller {
    @Inject
    ...
    private Procedure.ProcedureType getProcedureType() {
        return Procedure.ProcedureType.Surgery;
    }

    private String renderViewWithBaseDirectory(String view, Model model) {
        return renderView("theater/" + view, model);
    }
    ...
    @Action(path = "/", permission = AclPermission.ReadTheaterProcedures)
    ...
    @Action(path = "/New", permission = AclPermission.WriteTheaterProcedures)
    ...
    @Action(path = "/Add", method = HttpMethod.post, permission = AclPermission.WriteTheaterProcedures)
    ...
    @Action(path = "/Update", method = HttpMethod.post, permission = AclPermission.WriteTheaterProcedures)
    ...
    @Action(path = "/:id/Edit", permission = AclPermission.WriteTheaterProcedures)
    ...
    @Action(path = "/:id/Delete", permission = AclPermission.WriteTheaterProcedures)
